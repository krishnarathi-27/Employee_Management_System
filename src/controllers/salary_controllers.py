...
class SalaryControllers:
    ...
    def view_salary(self):
        data = db_object.fetch_data(Queries.QUERY_TO_DISPLAY_SALARY_DETAILS)
        return data
    
    def view_self_salary(self,user_id):
        data = db_object.fetch_data(Queries.QUERY_TO_DISPLAY_SELF_SALARY_STATUS,(user_id,))
        return data
    ...
    def save_salary_status(self,employee_id,salary_month):
        ...
        data = db_object.fetch_data(Queries.QUERY_TO_CALCULATE_LEAVES,(employee_id,))
        ...
        if not data:
            ...
            db_object.save_data(Queries.QUERY_TO_ADD_SALARY,(salary_id,salary,salary_month,'approved',employee_id,))
            return True
